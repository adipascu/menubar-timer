...
const buildPrompt = ({ poolFile, tipsFile, feedbackFile, quizFile }) => [
  ...
  '',
  `6. Then rewrite ${tipsFile} as a JSON array. ${PERSONAL_TIP_SHAPE} Write 20 to 40 of them, weighted toward the topics I asked for. Aim them at the gaps the quiz exposed and at the next step in those topics: come back at what I missed from a different angle, build on what I got right, go further on the cards I marked interested, and introduce what follows. Keep cards from the old file that I have not been quizzed on yet when they still fit.`,
  '',
  SOURCE_RULE,
  '',
