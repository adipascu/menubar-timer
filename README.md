...
69. add an option to remove the quit button in the menu, make the default to show. If you need an UI panel ebcause of too many settings, you can do it. /mr-polish /mr-new

69 prompts. 2 multiple-choice answers. 0 lines of code written or edited by a human.
